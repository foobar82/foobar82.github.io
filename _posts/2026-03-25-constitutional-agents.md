...
This is very much a case of deciding how far to build and whether now is the right time. Doing this first would have been over-engineering. Given the low volumes I'm currently handling, I'm arguably over-engineering *already* — so I'm going to park the meta-pipeline idea for now.
